...
export const getAllMedicines = async (options = {}) => {
    // ── Default values ────────────────────────────────────────
...
const updateMedicine = async (id, data, user) => {
...
const deleteMedicine = async (id, user) => {
    const medicine = await prisma.medicine.findUnique({
        where: { id },
        select: {
            sellerId: true,
...
const getMyMedicines = async (sellerId, options = {}) => {
